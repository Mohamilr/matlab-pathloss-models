...
% Output Table
T = table(d_m, A_vec, gamma_vec, X_f_vec, X_h_vec, S_vec, PL_SUI, ...
    RMSE_vec, Bias_vec, SDE_vec, MAE_vec, MPE_vec, R2_vec, Xstd_vec, ...
    'VariableNames', {'Distance_m', 'SUI_A', 'SUI_Gamma', 'SUI_X_f', 'SUI_X_h', 'SUI_S', 'SUI_PL', ...
                      'SUI_RMSE', 'SUI_Bias', 'SUI_SDE', 'SUI_MAE', 'SUI_MPE', 'SUI_R_squared', 'SUI_X_std'});

% Append mean row
mean_values = [mean(d_m), A, gamma, X_f, X_h, mean(S_vec), mean(PL_SUI), ...
               RMSE, Bias, SDE, MAE, MPE, R2, X_std];
